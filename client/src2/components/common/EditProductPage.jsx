...
function EditProductPage() {
  ...
  const saveProductToServer = (product) => {
    axios.patch(API_ENDPOINTS.UPDATE_PRODUCT_PARTIALLY(id), product)
      .then(() => {
    ...
    return productState.images
      ...
      .map((image, index) => (
        <div key={index} className="image-item">
          ...
          {image.products_info === 0 && (
            <div className="introduce-badge custom-badge">介紹圖</div>
          )}
        </div>
      ));
  };
  const renderProductImagesPutDel = (isModal = false) => {
    return productState.images
      ...
      .map((image, index) => (
        <div
          key={index}
          className={`image-item ${isModal && image.id === selectedImageId ? "selected" : ""}`}
          onClick={() => {
        ...
        >
          ...
          />
          {image.products_info === 0 && (
            <div className="introduce-badge">封面圖</div>
          )}
          {showDeleteButtons && (
  ...
  const uploadImage = async () => {
    ...
    try {
      const response = await fetch(API_ENDPOINTS.UPLOAD_PRODUCT_IMAGE(productState.product.prod_id), {
        method: 'POST',
        body: formData,
      });
  ...
  const changeCoverImage = async () => {
    if (selectedImageId) {
      try {
        const response = await axios.post(API_ENDPOINTS.UPDATE_COVER_IMAGE, { imageId: selectedImageId });
  ...
  return (
    <>
      ...
      <div className="top2 top2-b10px incontentText mt-3 p-4">
            ...
            <div className='row'>
              <div className='col-6'>
                <div className="gray3 incontentText titlerowfit top2-r10px ps-2">
                  <b>
                    {productState.product.prod_name}
                  </b>
                </div>
              </div>
              <div className='col-6'>
        ...
        <div className='row mt-5'>
          ...
          <div className='col'>
            ...
            <Modal show={showImageModal} onHide={() => setShowImageModal(false)}>
              ...
              <Modal.Body>
                {enlargedImageSrc && <img src={enlargedImageSrc} alt="Enlarged Product " className='enlarged-image' />}
              </Modal.Body>
              <Modal.Footer>
          ...
          <div className='col'>
            ...
            <div className='col-12 mt-2'>
              ...
              <Button variant="info" onClick={() => { setShowChangeCoverModal(true); setShowHint(true); }}>
                更改封面圖
              </Button>
            </div>
            <Modal show={showModal} onHide={handleModalClose}>
              ...
              <div className='row'>
                <Button variant="danger" onClick={() => setShowDeleteButtons(!showDeleteButtons)} className='col'>
        ...
        <div className='row mt-5'>
          ...
          <div className='col'>
            <div className="gray3">
              <b>
                {productState.product.sellspec && productState.product.sellspec[0] && productState.product.sellspec[0].contnet}
              </b>
            </div>
          ...
          <div className="col">
            ...
            <textarea
              ...
              rows={4}
              value={productState.product.sellspec && productState.product.sellspec[0] && productState.product.sellspec[0].contnet}
        ...
        <div className='row mt-5'>
          ...
          <div className='col'>
            <div className="gray3 incontentText titlerow top2-r10px ps-2">
              <b>
                {productState.sellSpecs && productState.sellSpecs.length > 0 && productState.sellSpecs[0].spec_name}
              </b>
            </div>
          </div>
          <div className="col">
            <input
              ...
              placeholder='請輸入要編輯名稱'
              className="form-control ms-1 input-right-placeholder"
              defaultValue={productState.sellSpecs && productState.sellSpecs.length > 0 ? productState.sellSpecs[0].spec_name : ""}
        ...
        <div className='row mt-5 mb-5'>
          ...
          <div className='col'>
            <div className="gray3 incontentText titlerow top2-r10px ps-2">
              <b>
                NT${productState.sellSpecs && productState.sellSpecs.length > 0 && productState.sellSpecs[0].price}
              </b>
            </div>
          </div>
          <div className="col">
            <input
              ...
              className="form-control ms-1 input-right-placeholder"
              defaultValue={productState.sellSpecs && productState.sellSpecs.length > 0 ? productState.sellSpecs[0].price : ""}
        ...
        <div className='row mt-5 mb-5'>
          ...
          <div className='col'>
            <div className="gray3 incontentText titlerow top2-r10px ps-2">
              <b>
                {productState.sellSpecs && productState.sellSpecs.length > 0 && productState.sellSpecs[0].stock}
              </b>
            </div>
          </div>
          <div className="col">
            <input
              ...
              className="form-control ms-1 input-right-placeholder"
              defaultValue={productState.sellSpecs && productState.sellSpecs.length > 0 ? productState.sellSpecs[0].stock : ""}
      ...
      <nav className="gray2 conarae d-flex justify-content-end">
        <button onClick={handleSave} className='btn btn-primary m-1'>保存更改</button>
      </nav>
