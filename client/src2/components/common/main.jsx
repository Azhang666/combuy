                    ...
                    product.map((prodItem, index) => (
                        <div key={index} className={index % 2 === 0 ? 'even-row' : 'odd-row'}>
                            <div className="row text-center d-flex align-items-center">
                                ...
                                <img src={`${API_ENDPOINTS.LOCALHOST}/${prodItem.img_src}`}
                                ...
                                <div className="col-2 titlefont">
                                    <Link to={`/products/edit/${prodItem.prod_id}`} className="btn btn-success m-1">修改</Link>
                                    <div className="btn btn-primary delData1">
                                        <MainButton productId={prodItem.prod_id} fetchProducts={fetchProducts} />
                                    </div>
                                </div>
                            </div>
                        </div>
