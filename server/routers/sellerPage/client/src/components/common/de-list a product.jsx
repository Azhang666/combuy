...
function Downproducts() {
    ...
    // 定義fetchProducts函數
    const fetchProducts = () => {
        axios.get('http://localhost:2407/downproducts')
            .then(response => {
                            ...
                            product.map((prodItem, index) => (
                                <div key={index} className={index % 2 === 0 ? 'even-row' : 'odd-row'}>
                                    <div className="row text-center d-flex align-items-center">
                                        ...
                                        <img src={`http://localhost:2407/${prodItem.img_src}`} className="col-2 titlefont" alt="" />
                                        ...
                                        <div className="col-2 titlefont">
                                            ...
                                            <div className="btn btn-primary delData1">
                                                <PublishProduct productId={prodItem.id} fetchProducts={fetchProducts} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
